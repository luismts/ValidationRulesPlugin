...
namespace Plugin.ValidationRules.Forms
{
    /// <summary>
    /// Provides a way for an object to be validated.
    /// </summary>
    /// <typeparam name="T">Type of the data to be validated</typeparam>
    public class ValidatableObject<T> : ExtendedBindableObject, IValidity, IDisposable
    {
        /// <summary>
        ...
        public List<string> Errors
        {
            ...
            {
                _errors = value;
                Error = _errors?.Count > 0 ? _errors.FirstOrDefault() : string.Empty;
